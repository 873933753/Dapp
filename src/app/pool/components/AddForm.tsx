  ...
  return(
    <>
      ...
      <div className="mb-4">
        <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
          <div className="flex justify-between mb-2">
            <label className="text-sm text-gray-600 dark:text-gray-300">Token A</label>
      ...
      <div className="flex justify-center -mt-2 mb-2 relative z-10">
        <div className="bg-white dark:bg-card border-4 border-gray-50 dark:border-gray-600 rounded-xl p-2">
      ...
      <div className="mb-6">
        <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
          <div className="flex justify-between mb-2">
            <label className="text-sm text-gray-600 dark:text-gray-300">Token B</label>
            <button className="text-sm text-blue-600 dark:text-blue-400">
      ...
      {/* 授权要授权TKA和TKB两种代币 */}
      {
        !isConnected ? (
          ...
          <button 
            ...
            className="bg-blue-100 dark:bg-blue-600 text-blue-500 dark:text-white w-full py-3 text-xl tracking-tight rounded-lg mt-6 cursor-pointer disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:text-white">
         ...
         : (
          <button
            ...
            className="bg-blue-100 dark:bg-blue-600 text-blue-500 dark:text-white w-full cursor-pointer disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:text-white font-semibold py-3 px-6 rounded-lg transition-colors"
          >
      ...
      {isAddSuccess && (
        <div className="mt-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
          <p className="text-green-800 dark:text-green-200 font-semibold">{t('Liquidity Added Successfully')}!</p>
          <a
